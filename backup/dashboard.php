...
echo "<th>title</th><th>description</th><th>lat</th><th>lng</th><th>date</th><th>resolved</th><th>resolve</th><th>delete</th>";
while($row=mysql_fetch_array($dbquery))
{ echo "<tr>";
$league_name=$row['title'];$country=$row['description'];$league_id=$row['ltd'];$league_id2=$row['lon'];$league_id3=$row['date'];$league_id4=$row['resolved'];
...
echo "<td>".$league_id4."</td>";
   echo "<td><a href='resolve.php?tit=$league_name' onclick='popitup(\"#menu3' >resolve</a></td>";
